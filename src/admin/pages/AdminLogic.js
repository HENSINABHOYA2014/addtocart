...
const AdminLogic = () => {
    ...
    const handleSubmit = async() => {
        try {
            let user =  await axios.get(`http://localhost:8000/admin?username=${username}&password=${password}`)
                ...
                <form className="row g-3 needs-validation" noValidate>
                  <div className="col-12">
                    ...
                    <div className="input-group has-validation">
                      ...
                      <input type="text" onChange={(e)=>setUserName(e.target.value)}  name="username" value={username} className="form-control" id="yourUsername" required />
                      <div className="invalid-feedback">Please enter your username.</div>
                    </div>
                  </div>
                  <div className="col-12">
                    <label htmlFor="yourPassword" className="form-label">Password</label>
                    <input type="password" name="password" onChange={(e)=>setPassword(e.target.value)} value={password} className="form-control" id="yourPassword" required />
